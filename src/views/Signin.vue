    ...
    <div class="signinBox">
      ...
      <el-form ref="signinForm" :model="signinForm"  class="signinForm"  label-width="0px">
        ...
        <el-form-item class="mb10" prop="password">
          <el-input v-model="signinForm.password" type="password" prefix-icon="fa fa-lock" placeholder="请输入密码"></el-input>
        </el-form-item>
    ...
    export default {
      ...
      methods :{
        signinFn(){
            ...
            if( form.username == "" ){
                this.alertBox("请输入账号","error") ; return false ;
            }
          if( form.password == "" ){
            this.alertBox("请输入密码","error") ; return false ;
          }
          var params = {
